...
<p>
    Cám ơn bạn đã đăng kí trang mua sắm INSTAR<br/>
    Thông tin đăng kí như sau:<br/>
    ...
    <?php printf( esc_html__( 'Tên tài khoản của bạn là %2$s. Bạn có thể truy cập trang tài khoản để xem đơn hàng, đổi mật khẩu, và nhiều thứ khác tại: %3$s', 'woocommerce' ), esc_html( $blogname ), '<strong>' . esc_html( $user_login ) . '</strong>', make_clickable( esc_url( wc_get_page_permalink( 'myaccount' ) ) ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
